...
const revealEls = document.querySelectorAll<HTMLElement>(".reveal");
  ...
  document.querySelectorAll<HTMLElement>(".accordion-item").forEach(item => {
    ...
    trigger.addEventListener("click", () => {
      ...
      if (parent) {
        parent.querySelectorAll<HTMLElement>(".accordion-item").forEach(other => {
          other.classList.remove("open");
          const opanel = other.querySelector<HTMLElement>(".accordion-panel");
  ...
  document.querySelectorAll<HTMLFormElement>("form[data-validate]").forEach(form => {
    form.addEventListener("submit", (e) => {
      ...
      const successBox = form.parentElement?.querySelector<HTMLElement>(".form-success");
      if (valid) {
        form.reset();
        form.querySelectorAll<HTMLElement>(".field").forEach(f => f.classList.remove("invalid"));
        if (successBox) {
